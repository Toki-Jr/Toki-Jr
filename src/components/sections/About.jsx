...
export default function About() {
    ...
    return (
        <section className="py-15 max-w-5xl mx-auto px-4">
            ...
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed m-4 border border-green-600 rounded-3xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {stats.map((item, index) => {
                        ...
                        <div
                            key={index}
                            className="group flex flex-col justify-between p-4 rounded-xl border border-green-600"
                        >
                            ...
                            <ChevronRight
                                size={14}
                                className="opacity-0 group-hover:opacity-100 transition-opacity text-zinc-400 dark:text-zinc-500"
                            />
                            </div>
                        </div>
                        );
